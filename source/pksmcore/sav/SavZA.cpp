...
namespace
{
    ...
    constexpr int otherItems[] = {
        45, 46, 47, 48, 49, 50, 52, 80, 81, 82,
        83, 84, 85, 103, 107, 108, 109, 116, 117, 118,
        119, 214, 217, 218, 221, 222, 230, 231, 232, 233,
        234, 236, 237, 238, 239, 240, 241, 242, 243, 244,
        245, 246, 247, 248, 249, 250, 251, 252, 253, 258,
        259, 266, 267, 268, 270, 275, 289, 290, 291, 292,
        293, 294, 296, 324, 534, 535, 537, 538, 540, 564,
        565, 566, 567, 568, 569, 570, 639, 640, 646, 647,
        710, 711, 795, 796, 849, 1124, 1125, 1126, 1127, 1128,
    ...
    constexpr int keyItems[] = {
        632, 700, 765, 847, 1278, 2588, 2589, 2590, 2591, 2592,
    ...
    constexpr int berryItems[] = {
        149, 150, 151, 152, 153, 155, 156, 157, 158, 169,
        170, 171, 172, 173, 174, 184, 185, 186, 187, 188,
    ...
    constexpr int tmItems[] = {
        ...
        418, 419, 618, 619, 620, 690, 691, 692, 693, 2160,
    ...
    constexpr int megaStoneItems[] = {
        ...
        762, 763, 764, 767, 768, 769, 770, 2559, 2560, 2561,
...
namespace pksm
{
    ...
    std::unique_ptr<PKX> SavZA::pkm(u8 box, u8 slot) const
    {
        ...
        return PKX::getPKM<PA9>(
            getBlock(Box)->decryptedData() + offset, PA9::PARTY_LENGTH);
    }
    ...
    void SavZA::mysteryGift(const WCX& wc, int&)
    {
        ...
        if (wa9.pokemon())
        {
            ...
            pa9->encryptionConstant(wa9.encryptionConstant()
                                        ? wa9.encryptionConstant()
            ...
            pa9->nature(wa9.nature() == Nature::INVALID ? Nature{u8(pksm::randomNumber(0, 24))}
                                                        : wa9.nature());
            pa9->gender(
                PKX::genderFromRatio(pksm::randomNumber(0, 0xFFFFFFFF), pa9->genderType()));
