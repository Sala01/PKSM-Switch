    ...
    namespace data
    {
        namespace emulator
        {
            ...
            public:
                ...
                static bool Save(const std::unordered_map<u64, EmulatorSaveSelection> &data, const std::string &path = DefaultConfigPath);

                static void AddPrimaryPath(std::unordered_map<u64, EmulatorSaveSelection> &data, u64 titleId, const std::string &path);
