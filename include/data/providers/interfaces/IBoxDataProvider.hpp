...
public:
    ...
    virtual bool SetPokemonData(
        ...
        int boxIndex,
        int slotIndex,
        const pksm::ui::BoxPokemonData &pokemonData) = 0;
    ...
    // Optional hooks for providers that persist outside of SaveData (e.g. Bank).
    // Defaults are no-op so callers can safely invoke them.
