...
namespace pksm::layout
{
    ...
    private:
        ...
        // Emulator save reconfigure confirm overlay
        bool isEmuReconfigConfirmVisible = false;
        pu::ui::Overlay::Ref emuReconfigConfirmOverlay;
        ...
        // Helper methods
        void LoadSaves();
        void ShowEmuReconfigConfirm();
        void HideEmuReconfigConfirm();
