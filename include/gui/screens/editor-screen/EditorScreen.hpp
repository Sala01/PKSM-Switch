...
namespace pksm::layout
{
    ...
    private:
        ...
        pu::ui::elm::TextBlock::Ref infoNicknameLabel;
        pu::ui::elm::TextBlock::Ref infoNicknameVal;
        pu::ui::elm::TextBlock::Ref infoOTLabel;
        pu::ui::elm::TextBlock::Ref infoOTVal;
        pu::ui::elm::TextBlock::Ref infoPokerusLabel;
        pu::ui::elm::TextBlock::Ref infoPokerusVal;
        pu::ui::elm::TextBlock::Ref infoNatureLabel;
        pu::ui::elm::TextBlock::Ref infoNatureVal;
        pu::ui::elm::TextBlock::Ref infoAbilityLabel;
        pu::ui::elm::TextBlock::Ref infoAbilityVal;
        pu::ui::elm::TextBlock::Ref infoItemLabel;
        pu::ui::elm::TextBlock::Ref infoItemVal;
        pu::ui::elm::TextBlock::Ref infoHpTypeLabel;
        pu::ui::elm::TextBlock::Ref infoHpTypeVal;
        ...
        pu::ui::elm::TextBlock::Ref statHpLbl;
        pu::ui::elm::TextBlock::Ref statHpIV;
        pu::ui::elm::TextBlock::Ref statHpEV;
        pu::ui::elm::TextBlock::Ref statHpST;
        pu::ui::elm::TextBlock::Ref statAtkLbl;
        pu::ui::elm::TextBlock::Ref statAtkIV;
        pu::ui::elm::TextBlock::Ref statAtkEV;
        pu::ui::elm::TextBlock::Ref statAtkST;
        pu::ui::elm::TextBlock::Ref statDefLbl;
        pu::ui::elm::TextBlock::Ref statDefIV;
        pu::ui::elm::TextBlock::Ref statDefEV;
        pu::ui::elm::TextBlock::Ref statDefST;
        pu::ui::elm::TextBlock::Ref statSpaLbl;
        pu::ui::elm::TextBlock::Ref statSpaIV;
        pu::ui::elm::TextBlock::Ref statSpaEV;
        pu::ui::elm::TextBlock::Ref statSpaST;
        pu::ui::elm::TextBlock::Ref statSpdLbl;
        pu::ui::elm::TextBlock::Ref statSpdIV;
        pu::ui::elm::TextBlock::Ref statSpdEV;
        pu::ui::elm::TextBlock::Ref statSpdST;
        pu::ui::elm::TextBlock::Ref statSpeeLbl;
        pu::ui::elm::TextBlock::Ref statSpeeIV;
        pu::ui::elm::TextBlock::Ref statSpeeEV;
        pu::ui::elm::TextBlock::Ref statSpeeST;
        ...
        {
            bool active = false;
            ActivePanel panel = ActivePanel::Boxes;
            int box = 0;
            int slot = 0;
        };
        GrabState grab;
