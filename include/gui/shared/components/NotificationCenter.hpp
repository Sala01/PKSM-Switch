...
namespace pksm::ui
{
    ...
    public:
        static constexpr pu::i32 TOAST_HEIGHT = 160;
        static constexpr pu::i32 TOAST_SPACING = 12;
        static constexpr pu::i32 TOAST_PADDING_X = 24;
        ...
        static constexpr pu::i32 BODY_EXTRA_BOTTOM = 24;
        static constexpr pu::i32 BODY_CORNER_RADIUS = 14;
        static constexpr pu::i32 BODY_LINE_SPACING = 6;

        static constexpr pu::i32 MIN_TOAST_HEIGHT = 160;
